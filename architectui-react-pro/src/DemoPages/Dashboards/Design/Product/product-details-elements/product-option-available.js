...
class ProductOptionAvailable extends React.Component<any, any> {
    ...
    render() {
        ...
        <div id="ProductOptionAvailable" className="HoverEffectDragDrop" style={{ backgroundColor: this.props.ProductCellBGColor }}>
            <div id="ProductOptionAvailable1">
				<div className="productOptionsArrow" style={{ color: this.props.OptionIconColor }}><i className="fa fa-angle-down"></i></div>
            ...
            <div id="ProductOptionAvailable1" style={{ display: 'none' }}>
				<div className="productOptionsArrow" style={{ color: 'rgb(186, 186, 186)' }}><i className="fa fa-angle-down"></i></div>
