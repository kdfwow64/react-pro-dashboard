        ...
        <ReactCSSTransitionGroup
            ...
            <Row>
              ...
              <ProductSettingsSection
                  ...
                  ProductPriceColorCallback={this.ProductPriceColorCallback}
                  ProductRatingColorCallback={this.ProductRatingColorCallback}
                  ProducttitlebarBGColorCallback={
                    this.ProducttitlebarBGColorCallback
                  }
                  AddLinkSecCallback={this.AddLinkSecCallback}
                  ExternalIconColorCallback={this.ExternalIconColorCallback}
                  ExternalLinkColorCallback={this.ExternalLinkColorCallback}
                  ExternalBGColorCallback={this.ExternalBGColorCallback}
                  ProductCellBGColorCallback={this.ProductCellBGColorCallback}
                  ...
                  DescHeaderBGColorCallback={this.DescHeaderBGColorCallback}
                  ...
                  ExternalLinkTitleCallback={this.ExternalLinkTitleCallback}
                  ...
                  ProducttitlebarBGColorValue={this.state.ProducttitlebarBGColor}
                  ...
                  MarginLeftTitleSectionValue={this.state.MarginLeftTitleSection}
