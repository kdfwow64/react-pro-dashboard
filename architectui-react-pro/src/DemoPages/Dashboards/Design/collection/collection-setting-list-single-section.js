...
class CollectionSettingListSingleSection extends React.Component  {
    ...
    render() {
        return (
            ...
            style={{ backgroundColor: this.props.CellBGColorValue, borderBottom: `1px solid ${this.props.CellseparatorColorValue}` }} >
                    ...
                    style={{ border: `1px solid ${this.props.productborderColorValue}` }}>
                     {
                        ...
                        <img src={this.props.ProdImageUrl} style={{ width: '100%', height: '100%', borderRadius: '30px', position: 'absolute', right: '0' }} />
                    }
                    {
                        !this.props.ProdImageUrl &&
                ...
                <div className="CollectionEffectListContainerTitleAndPrice">
                    ...
                    style={{ color: this.props.producttitleColorValue }}>{this.props.ProdTitle || 'PRODUCT'}</div>
                    <div className="CollectionEffectListProductPrice"
                    style={{ color: this.props.pricetitleColorValue || '#333333' }}>${this.props.ProdPrice}</div>
                    <div className="CollectionEffectListRightActionIcon"
                    style={{ color: this.props.CelliconColorValue || '#2ecc71' }}>
                        <i className={this.props.IconAction || 'lnr-chevron-right'}></i>
                    </div>
                </div>
            </div>
        );
