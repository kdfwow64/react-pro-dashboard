...
class SelectColorTheme extends React.Component  {
  ...
  onThemeOptionSelection = (themName,colorcode) => {
    ...
    this.setState({themName: themName});
  }
  goto_tutorial(){
    ...
    var landingTabDraggedItems = this.state.landingTabDraggedItems;
  ...
  componentWillMount() {
    this.getData()
      ...
      render() {
        ...
        return (
          <div>
            <div className="select_theme_container" style={{display: this.state.tutorial === true ? 'block' : 'none'}}>
              ...
              <li className={this.state.themName === 'default' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'ice' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'moonlight' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'bee' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'lavender' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'fire' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'emerald' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'night' ? 'active_theme' : ''}
                onClick={() => {
              ...
              <li className={this.state.themName === 'flamingo' ? 'active_theme' : ''}
                onClick={() => {
            ...
            <div className="select_theme_btn" style={{cursor: 'unset'}}>
                ...
                style={{backgroundColor: '#ccc', backgroundImage: 'unset', border: 'unset', color: '#000', cursor: 'unset'}}>NEXT</a>
            </div> }
            { this.state.showNextbtn === true &&
            <div className="select_theme_btn">
                <a onClick={this.goto_tutorial} >NEXT</a>
            </div>}
            { this.state.showNextbtn === false && <p style={{color: 'red', marginTop: '20px'}}>You must select a color scheme.</p> }
          </div>
            <div className="tutorial_container" style={{display: this.state.tutorial === false ? 'block' : 'none'}}>
              <div className="select_theme_title">
